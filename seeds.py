...
with app.app_context():
    ...
    transaction1 = Transaction(buy=True, price_of_deal=1000, view_count_at_deal='20303', user=thierry, videos=ariana_demo)
    transaction2 = Transaction(buy=True, price_of_deal=3992, view_count_at_deal='232332', user=thierry, videos=despacito)
    transaction3 = Transaction(buy=True, price_of_deal=3443, view_count_at_deal='433443', user=henry, videos=despacito)
    transaction4 = Transaction(buy=False, price_of_deal=23333, view_count_at_deal='122344', user=thierry, videos=despacito)
